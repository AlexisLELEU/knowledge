<?php /* Smarty version Smarty-3.1.19, created on 2018-06-12 21:27:34
         compiled from "/Users/Jonathan/Desktop/HETIC/2ème Année/SI_CRM-CMS/prestashop/admin4147egi7m/themes/default/template/controllers/orders/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1735894845b201ea68d2835-36533816%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9863e08ac2157408d50eefdf52cfc93c348795a5' => 
    array (
      0 => '/Users/Jonathan/Desktop/HETIC/2ème Année/SI_CRM-CMS/prestashop/admin4147egi7m/themes/default/template/controllers/orders/form.tpl',
      1 => 1527169470,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1735894845b201ea68d2835-36533816',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b201ea6b16032_78335084',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b201ea6b16032_78335084')) {function content_5b201ea6b16032_78335084($_smarty_tpl) {?>
...
', {
					...
					parse: function(data) {
						if (!data.found)
							$('#vouchers_err').html('<?php echo smartyTranslate(array('s'=>'No voucher was found','d'=>'Admin.Orderscustomers.Notification','js'=>1),$_smarty_tpl);?>
').show();
						else
							$('#vouchers_err').hide();
						var mytab = new Array();
...
",
		...
		$('#customer_part').on('click','button.setup-customer',function(e){
			...
			$(this).removeClass('setup-customer').addClass('change-customer').html('<i class="icon-refresh"></i>&nbsp;<?php echo smartyTranslate(array('s'=>"Change",'js'=>1),$_smarty_tpl);?>
').blur();
...
&id_customer=' + this.id_customer + '&viewcustomer&liteDisplaying=1" class="btn btn-default fancybox"><i class="icon-search"></i> <?php echo smartyTranslate(array('s'=>'Details','d'=>'Admin.Global','js'=>1),$_smarty_tpl);?>
</a>';
            html += '<button type="button" data-customer="' + this.id_customer + '" class="setup-customer btn btn-default pull-right" id="choose_customer_btn"><i class="icon-arrow-right"></i> <?php echo smartyTranslate(array('s'=>'Choose','d'=>'Admin.Actions','js'=>1),$_smarty_tpl);?>
</button>';
            html += '</div>';
            html += '</div>';
            html += '</div>';
          ...
          html = '<div class="alert alert-warning"><?php echo smartyTranslate(array('s'=>'No customers found','d'=>'Admin.Orderscustomers.Notification','js'=>1),$_smarty_tpl);?>
</div>';
        }
			...
			success : function(res)
			{
				if(res.found)
				{
					...
					$.each(res.carts, function() {
						...
						html_carts += '<a title="<?php echo smartyTranslate(array('s'=>'View this cart','d'=>'Admin.Orderscustomers.Feature','js'=>1),$_smarty_tpl);?>
...
&liteDisplaying=1#"><i class="icon-search"></i>&nbsp;<?php echo smartyTranslate(array('s'=>'Details','d'=>'Admin.Global','js'=>1),$_smarty_tpl);?>
</a>';
						html_carts += '&nbsp;<a href="#" title="<?php echo smartyTranslate(array('s'=>'Use this cart','d'=>'Admin.Orderscustomers.Feature','js'=>1),$_smarty_tpl);?>
" class="use_cart btn btn-default" rel="'+this.id_cart+'"><i class="icon-arrow-right"></i>&nbsp;<?php echo smartyTranslate(array('s'=>"Use",'d'=>'Admin.Orderscustomers.Feature','js'=>1),$_smarty_tpl);?>
</a>';
						html_carts += '</td>';
						html_carts += '</tr>';
					});
...
&id_order='+this.id_order+'&vieworder&liteDisplaying=1#" title="<?php echo smartyTranslate(array('s'=>'View this order','d'=>'Admin.Orderscustomers.Feature','js'=>1),$_smarty_tpl);?>
" class="fancybox btn btn-default"><i class="icon-search"></i>&nbsp;<?php echo smartyTranslate(array('s'=>"Details",'d'=>'Admin.Global','js'=>1),$_smarty_tpl);?>
</a>';
						html_orders += '&nbsp;<a href="#" "title="<?php echo smartyTranslate(array('s'=>'Duplicate this order','d'=>'Admin.Orderscustomers.Feature','js'=>1),$_smarty_tpl);?>
" class="duplicate_order btn btn-default" rel="'+this.id_order+'"><i class="icon-arrow-right"></i>&nbsp;<?php echo smartyTranslate(array('s'=>"Use",'d'=>'Admin.Orderscustomers.Feature','js'=>1),$_smarty_tpl);?>
</a>';
						html_orders += '</td>';
						html_orders += '</tr>';
					});
	...
	function updateDeliveryOptionList(delivery_option_list)
	{
		...
		{
			$('#carrier_form').hide();
			$('#carriers_err').show().html('<?php echo smartyTranslate(array('s'=>'No carrier can be applied to this order','d'=>'Admin.Orderscustomers.Notification','js'=>1),$_smarty_tpl);?>
');
...
",
			...
			success : function(res)
			{
				...
				if(res.found)
				{
					...
					$('#products_found').show();
					products_found += '<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Product','d'=>'Admin.Global','js'=>1),$_smarty_tpl);?>
</label><div class="col-lg-6"><select id="id_product" onclick="display_product_attributes();display_product_customizations();"></div>';
					attributes_html += '<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Combination','d'=>'Admin.Global','js'=>1),$_smarty_tpl);?>
					...
					$.each(res.products, function() {
						...
						{
							customization_html += '<div class="bootstrap"><div class="panel"><div class="panel-heading"><?php echo smartyTranslate(array('s'=>'Customization','d'=>'Admin.Catalog.Feature','js'=>1),$_smarty_tpl);?>
				...
				{
					$('#products_found').hide();
					$('#products_err').html('<?php echo smartyTranslate(array('s'=>'No products found','d'=>'Admin.Orderscustomers.Notification','js'=>1),$_smarty_tpl);?>
');
	...
	function updateCartProducts(products, gifts, id_address_delivery)
	{
		...
		$.each(gifts, function() {
			...
			cart_content += '<td><?php echo smartyTranslate(array('s'=>'Gift','js'=>1),$_smarty_tpl);?>
</td><td>'+this.cart_quantity+'</td><td><?php echo smartyTranslate(array('s'=>'Gift','d'=>'Admin.Orderscustomers.Feature','js'=>1),$_smarty_tpl);?>
</td></tr>';
		});
		...
		if (typeof(vouchers) == 'object')
			$.each(vouchers, function(){
				if (parseFloat(this.value_real) === 0 && parseInt(this.free_shipping) === 1)
					var value = '<?php echo smartyTranslate(array('s'=>'Free shipping','d'=>'Admin.Shipping.Feature','js'=>1),$_smarty_tpl);?>
';
				else
					var value = this.value_real;

				vouchers_html += '<tr><td>'+this.name+'</td><td>'+this.description+'</td><td>'+value+'</td><td class="text-right"><a href="#" class="btn btn-default delete_discount" rel="'+this.id_discount+'"><i class="icon-remove text-danger"></i>&nbsp;<?php echo smartyTranslate(array('s'=>'Delete','d'=>'Admin.Actions','js'=>1),$_smarty_tpl);?>
</a></td></tr>';
			});
...
&id_address="+this.id_address+"&updateaddress&realedit=1&liteDisplaying=1&submitFormAjax=1#";
		...
		{
			$('#addresses_err').show().html('<?php echo smartyTranslate(array('s'=>'You must add at least one address to process the order.','d'=>'Admin.Orderscustomers.Notification','js'=>1),$_smarty_tpl);?>
');
	...
	<div class="panel form-horizontal" id="customer_part">
		...
		<div id="search-customer-form-group" class="form-group">
			<label class="control-label col-lg-3">
				<span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="<?php echo smartyTranslate(array('s'=>'Search for an existing customer by typing the first letters of his/her name.','d'=>'Admin.Orderscustomers.Help','js'=>1),$_smarty_tpl);?>
">
...
=1" method="post" autocomplete="off">
	<div class="panel" id="products_part" style="display:none;">
		...
		<div class="form-group">
			<label class="control-label col-lg-3">
				<span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="<?php echo smartyTranslate(array('s'=>'Search for an existing product by typing the first letters of its name.','js'=>1),$_smarty_tpl);?>
">
